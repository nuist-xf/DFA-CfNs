...
#64 64
# parser.add_argument('--epochs', type=int, default=56, help='')
# parser.add_argument('--lr', type=float, default=0.001, help='learning rate')
# parser.add_argument('--patience', type=int, default=3, help='patience')
# parser.add_argument('--lr_d', type=float, default=0.9, help='inverse data')
...
#16 16
# parser.add_argument('--epochs', type=int, default=36, help='')
...
# parser.add_argument('--lr_d', type=float, default=0.4, help='inverse data')
...
#MLP
parser.add_argument('--mlp_hidden_size', type=int, default=512, help='MLP hidden size')

#TCN
parser.add_argument('--num_channels', nargs='+', type=int, default=[512, 256, 128], help='list of numbers of channels')
parser.add_argument('--level', type=float, default=3, help='levels of channels')
parser.add_argument('--kernel_size', type=int, default=3, help='kernel size')

#NN4IEs
parser.add_argument('--nn4ies_hidden_size', type=int, default=512, help='NN4IEs hidden size')
...
# parser.add_argument('--kernel_size', type=int, default=3, help='kernel size')
# parser.add_argument('--dropout', type=float, default=0.3, help='dropout rate')
parser.add_argument('--sd_kernel_size', nargs='+', type=int, default=[6, 24], help='list of numbers of channels')
...
def main():
    ...
    #NN4IEs
    # model = NN4IEs.Model(args)

    #SparseTSF
    # model = SparseTSF.Model(args)

    #KAN
    # model = KANceshi.Model(args)
    #CFC
    model = Cfc(
        in_features=12,
...
def plow(data, X, Y, model, batch_size):
    ...
    for X, Y in data.get_batches(X, Y, batch_size, False):
        ...
        if num == 0:
            ...
            inte_all = torch.cat([inte_all, inte], dim=0)
        num = num + 1

    return all_y_true, all_predict_value, inte_all
